...
/*						overflow:hidden;*/
                    ...
                    body { visibility:hidden; background:#0f000f; }
                    #home { 
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/EP_web_rabbit_2_backs_rolunk.jpg)no-repeat center;
					}
					#introduction {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/EP_web_rabbit_2_nyitolap.jpg)no-repeat center;
					}
					#cv {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/EP_web_rabbit_2_backs_info.jpg)no-repeat center;
					}
					.akciokClass {
						display:none;
					}
					#akciok {
						display:none;
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/EP_web_rabbit_2_backs_foglalas_galeria.jpg)no-repeat center;					
					}
					#behind_the_cv {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/EP_web_rabbit_2_backs_foglalas_galeria.jpg)no-repeat center;					
					}
                    ...
                    #contact { 
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/EP_web_rabbit_2_backs_kapcsolat.jpg)no-repeat center;
					}
                    .header {top:38px; border:none;}
                    .footer { border-top:1px solid #c3ff05;}
                    .slogen { margin:0px;}
					...
					#fancybox-right-ico, #fancybox-left-ico {
						background: #C3FF05 url(<?php echo Yii::app()->baseUrl; ?>/images/arrows.png) 35px -540px no-repeat;
					}
					.rolunkClass {
						/*display:none;*/
					}
					...
					.madness_btn, .rabbithole_btn {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/sprite.png) -1px -1px no-repeat;
					}
					.madness_btn:hover, .rabbithole_btn:hover {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/sprite.png) -94px -1px no-repeat;
					}
					...
					.facebook_btn {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/sprite.png) 2px -57px no-repeat;
						left: 800px;
						top: 573px;
					}
					.facebook_btn:hover {
						background:url(<?php echo Yii::app()->baseUrl; ?>/images/sprite.png) -90px -57px no-repeat;
					}
						...
						<div class="container">
							<div class="header">
								...
								<div class="nav">
                                	...
                                	<a href="<?php echo Yii::app()->createUrl('site/madness'); ?>" target="_blank" class="madness_btn"></a>
								...
								<div id="en_gallery_scroll" class="horizontal-scroll" style="margin-top:50px;">
									<div class="viewport">
										<div class="overview" style="width:6500px;">
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/01.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/01.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/02.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/02.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/03.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/03.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/04.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/04.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/05.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/05.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/06.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/06.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/07.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/07.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/08.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/08.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/09.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/09.png" alt="Rabbit hole" /></span>
												</a>
											</div>
											<div class="folio">
												<a class="overlay" rel="en_gallery" href="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/10.jpg" title="Rabbit hole">
													<span><img src="<?php echo Yii::app()->baseUrl; ?>/images/rabbit_hole/mini/10.png" alt="Rabbit hole" /></span>
												</a>
											</div>
					...
					********************* -->
					<div id="contact" class="menuitem" style="min-height:670px;">
						...
						<div class="container">
							...
							<div class="content">
								<h1>Contact</h1>
			<iframe src="<?php echo Yii::app()->baseUrl; ?>/clientside/map.html" style="border:none; border-style:none; width:600px; height:210px; margin-left:220px;" allowtransparency="transparent" frameborder="0" vspace="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                            ...
                            <div class="viewport">
                                <div class="overview">
												...
												<a href="http://atv.hu/videotar/20120913_kulonleges_szorakozas_a_kalvin_teren" title="Kapcsolat" target="_blank"><p>Különleges szórakozás a Kálvin téren - ATV Start Plusz</p></a>
													...
													<li>
												<p>
												<a href="http://hvg.hu/divat_design/20120905_Bezartak_minket_a_Kalvin_ter_ala_es_nem_j" title="Kapcsolat" target="_blank"><p>Bezártak minket a Kálvin tér alá és nem jutottunk ki – hvg.hu</p></a>
												</p>
													</li>
													<li>
												<p>

 ...
 * property or method in class "ExitAppointmentFree".
 *
 ...
 */
abstract class BaseExitAppointmentFree extends ExitAppointment {
	...
	public function defaultScope() {
		return array(
			'condition'=>"appointment_status='".exitConfig::EXIT_FREE_APPOINTMENT."'",
	        );
	}
